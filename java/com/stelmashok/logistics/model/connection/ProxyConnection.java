...
// Proxy is needed to protect against getting into the pool of "wild" connections created outside the pool
// to make it impossible to close connection outside the package with the connection pool and place it in our pool
// Proxy masquerades as a regular connection
public class ProxyConnection implements Connection {
    ...
    // No one should create a connection outside of a package with a connection pool, for this you need to write
    // a constructor with a package access.
    ProxyConnection(Connection connection) {
        this.connection = connection;
    }
    // In order to prevent closing a connection outside of a package with a connection pool.
    // Now if you call close, it will not destroy the connection, but return it to the connection pool.
    @Override
